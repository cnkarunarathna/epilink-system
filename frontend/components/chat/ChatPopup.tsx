      ...
      <AnimatePresence>
        {!open && (
          <motion.button
            ...
            whileTap={{ scale: 0.94 }}
            onClick={handleOpen}
            className="fixed bottom-6 right-6 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-primary text-primary-foreground shadow-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
                ...
                {searchOpen ? (
                  ...
                  <>
                    ...
                    <input
                      ...
                      className="flex-1 bg-transparent text-sm text-primary-foreground outline-none placeholder:text-primary-foreground/60"
                      autoFocus
                    />
                    {searchLoading ? (
                  ...
                  <>
                    ...
                    <div className="flex min-w-0 flex-1 flex-col">
                      ...
                      {taskTitle && (
                        <span className="truncate text-[11px] leading-tight text-primary-foreground/70">
                          {taskTitle}
                        </span>
                      )}
                    </div>
