        ...
        <div className="fixed bottom-20 right-6 w-[420px] max-h-[600px] z-50 flex flex-col rounded-2xl border-2 border-purple-200 dark:border-purple-800 shadow-2xl shadow-purple-200/30 dark:shadow-purple-900/20 bg-white dark:bg-slate-900 overflow-hidden animate-in fade-in-0 slide-in-from-bottom-5 zoom-in-95 duration-200">
          ...
          >
            {messages.length === 0 && !loading && (
              <div className="text-center py-4 space-y-3">
                <div className="flex justify-center">
                  <div className="p-3 bg-gradient-to-br from-purple-100 to-indigo-100 dark:from-purple-900/40 dark:to-indigo-900/40 rounded-2xl">
            ...
            {messages.map((msg) => (
              ...
              >
                {msg.role === "assistant" && (
                  <div className="p-1 bg-gradient-to-br from-purple-500 to-indigo-600 rounded-lg h-fit shadow shrink-0 mt-0.5">
            ...
            {loading && (
              <div className="flex gap-2.5 items-start animate-in fade-in-50">
                <div className="p-1 bg-gradient-to-br from-purple-500 to-indigo-600 rounded-lg shadow shrink-0">
                  <Bot className="h-3.5 w-3.5 text-white" />
                </div>
          ...
          <div className="flex gap-2 p-3 border-t border-slate-200 dark:border-slate-700 bg-slate-50/80 dark:bg-slate-800/50 shrink-0">
            ...
            <Button
              ...
              size="sm"
              className="bg-gradient-to-r from-purple-500 to-indigo-600 hover:from-purple-600 hover:to-indigo-700 text-white shadow h-9 px-3"
            >
              {loading ? (
      ...
      <button
        ...
        className={`fixed bottom-6 right-6 z-50 p-4 rounded-full shadow-2xl transition-all duration-300 ${
          open
            ...
            : "bg-gradient-to-br from-purple-500 to-indigo-600 hover:from-purple-600 hover:to-indigo-700 hover:scale-110 hover:shadow-purple-300/40 dark:hover:shadow-purple-700/40"
        }`}
